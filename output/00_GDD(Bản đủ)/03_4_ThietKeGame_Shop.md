...
Nhìn tổng thể, bảng drop rate này thực hiện một chức năng thiết kế đơn giản nhưng quan trọng: **tạo ra vòng phản hồi tự nhiên giữa tiến trình ván đấu và cơ hội trong shop** — không cần thêm hệ thống level up hay XP. Người chơi sống sót đủ lâu tự nhiên có quyền truy cập unit mạnh hơn, và đó là đủ.
