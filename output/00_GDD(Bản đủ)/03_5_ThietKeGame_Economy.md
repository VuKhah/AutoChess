...
Bốn kênh chi tiêu này tạo nên toàn bộ ngữ nghĩa kinh tế của game: **mua unit** là đầu tư vào sức mạnh trực tiếp hoặc tiến độ merge; **mua spell** là đầu tư vào đòn bẩy (multiplier lên unit sẵn có); **reroll** là đầu tư vào thông tin và cơ hội; **bán** là tái phân bổ tài nguyên đã đóng băng. Không có kênh nào tuyệt đối tốt hơn — câu hỏi luôn là "loại giá trị nào còn thiếu nhất lúc này?" Đây là lý do Chromosome trong Chương 5 cần đến 14 gene riêng (nhóm 6–8) chỉ để mã hóa chính sách kinh tế của bot.
...
Sáu nhóm chức năng này không chỉ là cách phân loại — chúng định nghĩa sáu **heuristic timing** khác nhau: buff trực tiếp (bất kỳ lúc nào), tuyển quân (khi cần thêm unit không muốn reroll), economy (càng sớm càng tốt để hòa vốn), upgrade (khi đã có unit đủ tốt để đầu tư vào), tái phân bổ (khi đội hình sắp được finalise), rủi ro cao (khi cần coin ngay và vị thế HP cho phép). Chromosome trong Chương 5 dùng đến 4 gene riêng (genes[28–31]) để mã hóa chính sách mua spell — phản ánh đúng mức độ phức tạp của quyết định này.
