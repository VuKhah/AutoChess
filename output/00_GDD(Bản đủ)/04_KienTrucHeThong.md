...
Toàn bộ logic "card nào có thể xuất hiện trong shop" nằm gọn trong `CardDatabase.GetRandomUnitShop()` — không rải rác khắp codebase. Điều này là yêu cầu thiết kế quan trọng: khi thêm card mới hay thay đổi drop rate, chỉ cần sửa một nơi duy nhất và hệ thống — bao gồm cả shop thật lẫn headless training — tự động cập nhật.
...
Kết quả không phải một kiến trúc "đẹp trên lý thuyết" — mà là một hệ thống có thể chạy hơn 2 triệu trận đấu mô phỏng trong vòng 20–30 phút, đồng thời cung cấp trải nghiệm chơi game hoàn chỉnh với UI tương tác và feedback visual. Cùng một codebase phục vụ cả hai mục đích mà không cần bất kỳ điều chỉnh runtime nào — đó là dấu hiệu của một kiến trúc đã làm đúng việc của mình.

Chương 5 sẽ đi vào bên trong `GameSimulator` và `GATrainer` — hai thành phần mà Chương 4 đã đặt nền tảng kỹ thuật nhưng chưa giải thích tại sao chúng được thiết kế như vậy. Câu trả lời nằm ở chromosome: cách 37 gene mã hóa một chiến lược chơi, và cách GA tiến hóa ra những chiến lược đó qua hàng triệu trận đấu mô phỏng.
