...
Bảy hành động trên — mua, giữ tay, bán, reroll, freeze, mua spell, và trigger EndTurnShop — không phải danh sách tùy tiện. Chúng tạo thành đúng **không gian quyết định cần thiết và đủ** của một lượt: kiểm soát đội hình (mua/bán/giữ tay), kiểm soát thông tin shop (reroll/freeze), kiểm soát combat power (spell), và xác nhận lượt (Fight → trigger EndTurnShop). Không có hành động nào thừa; thiếu bất kỳ hành động nào cũng làm mất đi một chiều chiến lược.
