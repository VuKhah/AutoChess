...
Tám lớp thông tin trên một lá bài nhỏ nghe có vẻ dày đặc — nhưng chúng được phân tầng theo tần suất sử dụng thực tế: sprite và stats được đọc mỗi lần nhìn vào, ability icon và keyword icon mỗi khi cân nhắc mua, description text chỉ khi cần tra cứu kỹ. Thiết kế theo tầng này giúp lá bài không bao giờ thực sự "quá nhiều thông tin" — mỗi lớp chỉ huy động sự chú ý của người chơi khi họ đang ở đúng ngữ cảnh cần nó. Đây là lý do card design này phục vụ được cả người mới (chỉ nhìn sprite + stats) lẫn người chơi có kinh nghiệm (đọc ability icon, tính merge stars, so sánh tier).
...
Lựa chọn này xuất phát từ đặc thù của Auto Chess: trong một lượt Shop Phase, người chơi cần đánh giá đồng thời shop (5 card), tay (hand), board của mình, và board đối thủ vừa thấy ở lượt combat trước. Mỗi lần phải mở menu, đọc option, xác nhận là một lần ngắt luồng tư duy chiến lược đó. Drag and drop ánh xạ trực tiếp *ý định vật lý* thành *hành động game*: kéo từ shop lên board = mua và deploy; kéo vào sell zone = bán; kéo spell lên unit = cast. Không có bước trung gian nào hỏi "bạn có chắc không?".
...
Bảng hành vi bảy dòng ở trên có thể trông phức tạp trên giấy, nhưng người chơi không cần học bảng đó — họ học nó bằng cách thử lần đầu và nhận kết quả trực tiếp. Đây là ưu điểm cốt lõi của drag and drop so với menu: *hành vi được khám phá qua tương tác, không qua đọc hướng dẫn*.
...
Nhìn lại toàn bộ Chương 3 — từ tầm nhìn (3.1), vòng lặp (3.2), hệ thống bài (3.3), shop (3.4), kinh tế (3.5), chiến đấu (3.6), cân bằng (3.7) đến giao diện (3.8) — một nguyên tắc thiết kế nhất quán xuyên suốt: mỗi thành phần tồn tại để phục vụ một quyết định cụ thể trong tay người chơi. Shop ngẫu nhiên tạo ra quyết định mua; kinh tế coin tạo ra quyết định tiết kiệm hay đầu tư; combat tự động chuyển kết quả quyết định đó thành điểm số; giao diện drag and drop giảm thiểu khoảng cách giữa ý định và hành động. Không có thành phần nào "vì có thể làm được" — tất cả đều "vì cần thiết cho vòng lặp".

UI/UX là lớp cuối cùng trong chuỗi thiết kế đó: nó không quyết định game có thú vị hay không, nhưng quyết định liệu những gì được thiết kế ở các mục trước có *tiếp cận được* đến người chơi hay không. Một mechanic tốt bị ẩn sau giao diện khó dùng là mechanic lãng phí. Chương 4 sẽ đi xuống tầng bên dưới tất cả những điều này — kiến trúc kỹ thuật cho phép toàn bộ Game Design Document trong Chương 3 hoạt động đúng như thiết kế.
