...
Đọc bảng từ góc độ kinh tế: **shop tier progression là cơ chế cấp phép tự nhiên theo thời gian** — không cần coin, không cần hành động chủ động từ người chơi. Nó tạo ra lợi thế sống sót rõ ràng (sống đến lượt 11 = quyền truy cập pool đầy đủ) mà không tạo ra bất bình đẳng chiến lược (cả người chơi lẫn bot đều tiến theo cùng nhịp). Đây là lý do game không cần hệ thống "lên level" phức tạp như TFT — tier progression đã thực hiện cùng chức năng với cơ chế đơn giản hơn nhiều.
