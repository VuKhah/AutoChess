...
**Tên tựa game:** AutoChess: Pantheon *(tên công việc — working title)*
**Thể loại:** Auto Battler / Auto Chess — chiến thuật theo lượt, chiến đấu tự động
**Nền tảng phát triển:** PC (Windows), Unity Engine 2022+, C#
**Chế độ chơi:** Đơn người chơi (Single-player PvE) — Người chơi đối đầu với AI bot qua nhiều lượt liên tiếp
**Trạng thái:** Prototype hoàn chỉnh, đủ tính năng để trải nghiệm toàn bộ vòng lặp gameplay
